...
(function(e){var r=require("./resource-shadow");if(exports.ResourceShadow=r,exports.create=r.create,e.browser)exports.version="0.0.7",exports.homepage="https://github.com/benjamine/resource-shadow";else{var o=require("../package.json");exports.version=o.version,exports.homepage=o.homepage}}).call(this,require("_process"));
...
function ResourceShadow(t){this.data={},this.localKey=t.localKey,this.url=t.url,this.options=t,this.localStorage=t.localStorage||localStorage,this.localStorageObserver=t.localStorageObserver||(defaultLocalStorageObserver=defaultLocalStorageObserver||require("./local-storage-observer")),this.httpHandler=t.httpHandler||(defaultHttpHandler=defaultHttpHandler||require("./http-handler")),this.load(),this.localStorageObserver&&this.listenForStorageEvent()}var microee=require("microee"),defaultHttpHandler,defaultLocalStorageObserver;microee.mixin(ResourceShadow),ResourceShadow.create=function(t){return new ResourceShadow(t)},ResourceShadow.prototype.apply=function(t){var e=this.beforeApply();try{"object"==typeof t?this.mirrorObject(t,this.data):t.call(this,this.data)}finally{return this.afterApply(e),this}},ResourceShadow.prototype.beforeApply=function(){var t=this.localStorage.getItem(this.localKey);return this.mirrorObject(this.getLocalStorageValue(),this.data),t},ResourceShadow.prototype.afterApply=function(t){this.setLocalStorageValue(this.data),this.save();var e=this.localStorage.getItem(this.localKey);e!==t&&this.onChange({source:"apply"})},ResourceShadow.prototype.save=function(){if(!this.loading&&!this.saving){if(!this.url)return void this.onSaved();var t=this.localStorage.getItem(this.localKey);if(this.shadow!==t){this.saving=!0;var e=this;this.httpHandler.put(this.url,this.httpHeaders(),t,function(o,r){return e.saving=!1,e.discardNextServerResponse?(e.discardNextServerResponse=!1,void e.emit("serverresponsediscarded")):o?void e.onSaveError(o):(e.onSaved(),void e.processJsonFromServer(r,t))})}else this.onSaved()}},ResourceShadow.prototype.loadAndRebase=function(){return this.load({})},ResourceShadow.prototype.loadLocal=function(t){var e=this.stringify(this.data);if(this.localStorage.getItem(this.localKey)!==e){var o=this.mirrorObject(this.getLocalStorageValue(),this.data);o&&(t=t||{},t.source=t.source||"localStorage",this.onChange(t))}},ResourceShadow.prototype.load=function(t){if(this.loadLocal(),this.loading||this.saving)return this;if(!this.url)return this.onLoaded(),this;var e;t?(e=t,"string"!=typeof e&&(e=this.stringify(e))):e=this.localStorage.getItem(this.localKey),this.loading=!0;var o=this;return this.httpHandler.get(this.url,this.httpHeaders(),function(r,a){return o.loading=!1,o.discardNextServerResponse?(o.emit("serverresponsediscarded"),void(o.discardNextServerResponse=!1)):r?(r.loadArguments=[t],void o.onLoadError(r)):(o.processJsonFromServer(a,e),void o.onLoaded())}),this},ResourceShadow.prototype.processJsonFromServer=function(t,e){this.shadow=t;var o=this.localStorage.getItem(this.localKey);if(t!==e){var r=!1;if(e!==o&&(t=this.threeWayMerge(e,t,o),"object"==typeof t&&(t=this.stringify(t)),r=t!==this.shadow),t!==o){var a,s=!0;try{a=this.parse(t)}catch(i){a=null}"object"==typeof a&&(s=this.mirrorObject(a,this.data)),s&&(this.setLocalStorageValue(this.data),this.onChange({source:"server"}))}r&&this.save()}else e!==o&&this.save()},ResourceShadow.prototype.listenForStorageEvent=function(){if(!this.listeningForStorageEvent&&this.localStorageObserver){var t=this;this.localStorageObserver.onKeyChange(this.localKey,function(){this.settingLocalStorage||t.loadLocal({source:"localStorageEvent"})}),this.listeningForStorageEvent=!0}},ResourceShadow.prototype.mirrorObject=function(t,e){function o(t,e,o){var a=t[o],s=e[o];return s===a?!1:"undefined"!=typeof s&&"object"==typeof a&&"object"==typeof s&&a instanceof Array==s instanceof Array?r.mirrorObject(a,s):(e[o]=a,!0)}var r=this;if("object"!=typeof t||"object"!=typeof e)return!1;var a=!1;if(t instanceof Array&&e instanceof Array){for(var s=t.length,i=0;s>i;i++)o(t,e,i)&&(a=!0);return e.length!==t.length&&(e.length=t.length,a=!0),a}for(var n in t)o(t,e,n)&&(a=!0);for(n in e)"undefined"==typeof t[n]&&(delete e[n],a=!0);return a},ResourceShadow.prototype.threeWayMerge=function(t,e,o){return this.options.threeWayMerge?this.options.threeWayMerge.call(this,t,e,o):o},ResourceShadow.prototype.parse=function(t){return JSON.parse(t)},ResourceShadow.prototype.stringify=function(t){return JSON.stringify(t)},ResourceShadow.prototype.httpHeaders=function(){return this.options.headers},ResourceShadow.prototype.onChange=function(t){this.emit("change",this.data,t)},ResourceShadow.prototype.onSaved=function(){this.emit("saved")},ResourceShadow.prototype.onLoaded=function(){this.emit("loaded")},ResourceShadow.prototype.shouldRetry=function(t){return this.options.retry===!1?!1:t.status&&[408,409,410,419,420,429,500,502,503,504,509,521,522,524,598,599].indexOf(t.status)<0?!1:!0},ResourceShadow.prototype.onSaveError=function(t){var e=this;this.shouldRetry(t)&&setTimeout(function(){e.save()},this.options.retryDelay||5e3),this.emit("saveerror",t)},ResourceShadow.prototype.onLoadError=function(t){var e=this;this.shouldRetry(t)&&setTimeout(function(){e.load.apply(e,t.loadArguments)},this.options.retryDelay||5e3),this.emit("loaderror",t)},ResourceShadow.prototype.setUrl=function(t,e){return this.url=t,e&&(this.options.headers=e),this},ResourceShadow.prototype.reset=function(t){return(this.loading||this.saving)&&(this.discardNextServerResponse=!0),this.url=null,this.mirrorObject(t||{},this.data),this.setLocalStorageValue(this.data),this.onChange({source:"reset"}),this},ResourceShadow.prototype.getLocalStorageValue=function(){var t=this.localStorage.getItem(this.localKey);if(null===t||"undefined"==typeof t||""===t)return{};try{return this.parse(t)||{}}catch(e){return{}}},ResourceShadow.prototype.setLocalStorageValue=function(t){var e;if(null===t||"undefined"==typeof t)e=null;else try{e=this.stringify(t)}catch(o){e=null}var r=this.localStorage.getItem(this.localKey);this.settingLocalStorage=!0;try{r!==e&&(null===e?this.localStorage.removeItem(this.localKey):this.localStorage.setItem(this.localKey,e))}finally{this.settingLocalStorage=!1}return e},module.exports=ResourceShadow;
