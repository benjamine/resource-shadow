...
function ResourceShadow(t){this.localKey=t.localKey,this.url=t.url,this.options=t,this.localStorage=t.localStorage||localStorage,this.httpHandler=t.httpHandler||(defaultHttpHandler=defaultHttpHandler||require("./http-handler")),this.load()}var microee=require("microee"),defaultHttpHandler;microee.mixin(ResourceShadow),ResourceShadow.create=function(t){return new ResourceShadow(t)},ResourceShadow.prototype.apply=function(t){var e=this.beforeApply();try{e=t(e)||e}finally{return this.afterApply(e),this}},ResourceShadow.prototype.beforeApply=function(){return this.getLocalStorageValue()},ResourceShadow.prototype.afterApply=function(t){this.setLocalStorageValue(t),this.data=t,this.save(),this.onChange()},ResourceShadow.prototype.save=function(){if(!this.loading&&!this.saving){if(this.saveRequested=!1,!this.url)return void this.onSaved();var t=this.localStorage.getItem(this.localKey);if(this.shadow!==t){this.saving=!0;var e=this;this.httpHandler.put(this.url,this.httpHeaders(),t,function(o,r){return e.saving=!1,o?void e.onSaveError(o):(e.onSaved(),void e.processJsonFromServer(r,t))})}else this.onSaved()}},ResourceShadow.prototype.loadAndRebase=function(){return this.load({})},ResourceShadow.prototype.load=function(t){if(this.data=this.getLocalStorageValue(),this.loading||this.saving)return this;if(!this.url)return this.onLoaded(),this;var e;t?(e=t,"string"!=typeof e&&(e=this.stringify(e))):e=this.localStorage.getItem(this.localKey),this.loading=!0;var o=this;return this.httpHandler.get(this.url,this.httpHeaders(),function(r,s){return o.loading=!1,r?(r.loadArguments=[t],void o.onLoadError(r)):(o.processJsonFromServer(s,e),void o.onLoaded())}),this},ResourceShadow.prototype.processJsonFromServer=function(t,e){this.shadow=t;var o=this.localStorage.getItem(this.localKey);if(t!==e){var r=!1;e!==o&&(t=this.threeWayMerge(e,t,o),"object"==typeof t&&(t=this.stringify(t)),r=t!==this.shadow);try{this.data=this.parse(t)}catch(s){this.data=null}this.setLocalStorageValue(this.data),this.onChange(),r&&this.save()}else e!==o&&this.save()},ResourceShadow.prototype.threeWayMerge=function(t,e,o){return this.options.threeWayMerge?this.options.threeWayMerge.call(this,t,e,o):o},ResourceShadow.prototype.parse=function(t){return JSON.parse(t)},ResourceShadow.prototype.stringify=function(t){return JSON.stringify(t)},ResourceShadow.prototype.httpHeaders=function(){return this.options.headers},ResourceShadow.prototype.onChange=function(){this.emit("change")},ResourceShadow.prototype.onSaved=function(){this.emit("saved")},ResourceShadow.prototype.onLoaded=function(){this.emit("loaded")},ResourceShadow.prototype.shouldRetry=function(t){return this.options.retry===!1?!1:t.status&&[408,409,410,419,420,429,500,502,503,504,509,521,522,524,598,599].indexOf(t.status)<0?!1:!0},ResourceShadow.prototype.onSaveError=function(t){var e=this;this.shouldRetry(t)&&setTimeout(function(){e.save()},this.options.retryDelay||5e3),this.emit("saveerror",t)},ResourceShadow.prototype.onLoadError=function(t){var e=this;this.shouldRetry(t)&&setTimeout(function(){e.load.apply(e,t.loadArguments)},this.options.retryDelay||5e3),this.emit("loaderror",t)},ResourceShadow.prototype.setUrl=function(t,e){return this.url=t,e&&(this.options.headers=e),this},ResourceShadow.prototype.getLocalStorageValue=function(){var t=this.localStorage.getItem(this.localKey);if(null===t||"undefined"==typeof t||""===t)return null;try{return this.parse(t)}catch(e){return null}},ResourceShadow.prototype.setLocalStorageValue=function(t){var e;if(null===t||"undefined"==typeof t)e=null;else try{e=this.stringify(t)}catch(o){e=null}return null===e?this.localStorage.removeItem(this.localKey):this.localStorage.setItem(this.localKey,e),e},module.exports=ResourceShadow;
},{"./http-handler":5,"microee":3}]},{},[1])(1)
});
