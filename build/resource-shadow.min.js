...
(function(e){var r=require("./resource-shadow");if(exports.ResourceShadow=r,exports.create=r.create,e.browser)exports.version="0.0.9",exports.homepage="https://github.com/benjamine/resource-shadow";else{var o=require("../package.json");exports.version=o.version,exports.homepage=o.homepage}}).call(this,require("_process"));
